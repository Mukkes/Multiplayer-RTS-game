	...
	public static class LoadManager
	{
		...
		private static void LoadLighting(JsonTextReader reader)
		{
			...
			while (reader.Read())
			{
				...
				{
					GameObject sun = (GameObject)Object.Instantiate(ResourceManager.GetWorldObject("Sun"), position, rotation);
		...
		private static void LoadTerrain(JsonTextReader reader)
		{
			...
			while (reader.Read())
			{
				...
				{
					GameObject ground = (GameObject)Object.Instantiate(ResourceManager.GetWorldObject("Ground"), position, rotation);
